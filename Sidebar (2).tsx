        ...
        <div className="p-4 border-t border-[#2d2d2d] bg-[#1a1c1e]">
          <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-[#2d2d2d] transition-colors group relative">
            <img 
              ...
              className={`w-9 h-9 rounded-full bg-gray-700 object-cover border ${currentUser?.isGuest ? 'border-yellow-500/50' : 'border-[#3d3d3d]'}`}
              alt="User"
            />
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-gray-200 truncate flex items-center gap-2">
                ...
                {currentUser?.isGuest && (
                  <span className="text-[8px] bg-yellow-500/10 text-yellow-500 px-1 rounded border border-yellow-500/20 uppercase font-bold">Guest</span>
                )}
              </p>
